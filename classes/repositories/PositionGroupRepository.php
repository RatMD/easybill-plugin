...
class PositionGroupRepository extends Repository
{
     ...
     * @var string
     */
    public const PATH = 'position-groups';
     ...
     * @inheritDoc
     */
    public function create(EasyBillModel $positionGroup): Model
    {
        throw new \Exception('Not implemented yet.');
    }
     ...
     * @inheritDoc
     */
    public function update(int $id, EasyBillModel $positionGroup): Model
    {
        throw new \Exception('Not implemented yet.');
    }
